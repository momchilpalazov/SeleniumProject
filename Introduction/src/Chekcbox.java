...
public class Chekcbox {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Assert.assertFalse(driver
				.findElement(By.cssSelector("label[for='ctl00_mainContent_chk_SeniorCitizenDiscount']")).isSelected());

		// System.out.println(
		// driver.findElement(By.cssSelector("label[for='ctl00_mainContent_chk_SeniorCitizenDiscount']")).isSelected());
